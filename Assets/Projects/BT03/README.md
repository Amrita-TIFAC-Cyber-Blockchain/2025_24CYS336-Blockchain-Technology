...
dcdvs-project/
├── contracts/
│   ├── CertificateVerifier.sol        # Core Smart Contract (Updated for IPFS)
│   └── Migrations.sol
├── migrations/
...
│   ├── src/
│   │   ├── components/
│   │   │   ├── AdminView.js           # Admin CRUD + IPFS Upload Logic
│   │   │   ├── Header.js              # Wallet/Status Display
│   │   │   └── UserView.js            # Verification UI + IPFS Link Display
│   │   ├── contracts/                 # Contract ABI JSON files (Auto-generated by Truffle)
│   │   │   ├── CertificateVerifier.json
│   │   │   └── Migrations.json
│   │   ├── utils/
│   │   │   └── web3Service.js         # Ethers.js, MetaMask Connection, IPFS Client
│   │   ├── App.js                     # Main Component, Role Detection, State Management
│   │   ├── index.css
│   │   └── index.js                   # React entry point
│   ├── package.json
│   └── README.md
├── .env                               # Environment Variables (Mnemonic/Private Key)
└── truffle-config.js                  # Truffle Configuration (Port 8545, Chain ID 31337)
------
